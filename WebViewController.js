...
WebViewController.prototype.updateOffset = function(){
  ...
  this.webView.evaluateJavaScript('document.getElementsByClassName("lmt__side_container--target")[0].getBoundingClientRect().top + document.body.scrollTop+document.documentElement.scrollTop;\
  document.getElementById("lmt_pro_ad_container").remove();\
  document.getElementById("lmt_quotes_article").remove();\
  document.getElementsByClassName("dl_footer dl_top_element--wide")[0].remove();\
  document.getElementsByClassName("lmt__side_container lmt__side_container--source")[0].getElementsByClassName("lmt__language_container")[0].remove();\
  document.getElementsByClassName("lmt__side_container lmt__side_container--target")[0].getElementsByClassName("lmt__language_container")[0].remove();\
  document.getElementsByClassName("lmt__rating")[0].remove();\
  document.getElementsByClassName("lmt__stickyMenubar_background lmt__stickyMenubar_background--hide")[0].remove();\
  ',function(ret){
